...
func (in *FinetuneExperimentSpec) DeepCopyInto(out *FinetuneExperimentSpec) {
	*out = *in
	...
	if in.ScoringPluginConfig != nil {
		in, out := &in.ScoringPluginConfig, &out.ScoringPluginConfig
		*out = new(ScoringPluginConfig)
		**out = **in
	}
	if in.ServeConfig != nil {
		in, out := &in.ServeConfig, &out.ServeConfig
		*out = new(ServeConfig)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in *FinetuneStatus) DeepCopyInto(out *FinetuneStatus) {
	*out = *in
	if in.LLMCheckpoint != nil {
		in, out := &in.LLMCheckpoint, &out.LLMCheckpoint
		*out = new(Checkpoint)
		**out = **in
	}
	if in.RayJobInfo != nil {
		in, out := &in.RayJobInfo, &out.RayJobInfo
		*out = new(RayJobInfo)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RayJobInfo) DeepCopyInto(out *RayJobInfo) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RayJobInfo.
func (in *RayJobInfo) DeepCopy() *RayJobInfo {
	if in == nil {
		return nil
	}
	out := new(RayJobInfo)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ScoringPluginConfig) DeepCopyInto(out *ScoringPluginConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ScoringPluginConfig.
func (in *ScoringPluginConfig) DeepCopy() *ScoringPluginConfig {
	if in == nil {
		return nil
	}
	out := new(ScoringPluginConfig)
